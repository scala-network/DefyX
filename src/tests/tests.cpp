...
int main() {
	...
	runTest("Cache initialization", RANDOMX_ARGON_ITERATIONS == 4 && RANDOMX_ARGON_LANES == 2 && RANDOMX_ARGON_MEMORY == 262144 && stringsEqual(RANDOMX_ARGON_SALT, "Panthera\x03"), []() {
	...
	runTest("Dataset initialization (interpreter)", stringsEqual(RANDOMX_ARGON_SALT, "Panthera\x03"), []() {
		initCache("test key 000");
	...
	runTest("Dataset initialization (compiler)", RANDOMX_HAVE_COMPILER && stringsEqual(RANDOMX_ARGON_SALT, "Panthera\x03"), []() {
		initCache("test key 000");
	...
	runTest("Hash test 1a (interpreter)", stringsEqual(RANDOMX_ARGON_SALT, "Panthera\x03"), test_a);

	runTest("Hash test 1b (interpreter)", stringsEqual(RANDOMX_ARGON_SALT, "Panthera\x03"), test_b);

	runTest("Hash test 1c (interpreter)", stringsEqual(RANDOMX_ARGON_SALT, "Panthera\x03"), test_c);

	runTest("Hash test 1d (interpreter)", stringsEqual(RANDOMX_ARGON_SALT, "Panthera\x03"), test_d);

	runTest("Hash test 1e (interpreter)", stringsEqual(RANDOMX_ARGON_SALT, "Panthera\x03"), test_e);
	...
	runTest("Hash test 2a (compiler)", RANDOMX_HAVE_COMPILER && stringsEqual(RANDOMX_ARGON_SALT, "Panthera\x03"), test_a);

	runTest("Hash test 2b (compiler)", RANDOMX_HAVE_COMPILER && stringsEqual(RANDOMX_ARGON_SALT, "Panthera\x03"), test_b);

	runTest("Hash test 2c (compiler)", RANDOMX_HAVE_COMPILER && stringsEqual(RANDOMX_ARGON_SALT, "Panthera\x03"), test_c);

	runTest("Hash test 2d (compiler)", RANDOMX_HAVE_COMPILER && stringsEqual(RANDOMX_ARGON_SALT, "Panthera\x03"), test_d);

	runTest("Hash test 2e (compiler)", RANDOMX_HAVE_COMPILER && stringsEqual(RANDOMX_ARGON_SALT, "Panthera\x03"), test_e);
